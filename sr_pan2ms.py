...
def normlization(data, min_max=(-1, 1)):
    ...
    data = (data - min_max[0]) / \
           (min_max[1] - min_max[0])
    return data.reshape((8, size, size))
...
if __name__ == "__main__":
    ...
    if opt['phase'] == 'train':
        ...
        while current_epoch < n_epochs:
            ...
            tb_logger.add_scalar("lr", diffusion.scheduler.get_last_lr(), current_epoch)
            ...
            if current_epoch % opt['train']['val_freq'] == 0:
                ...
                for _, val_data in enumerate(val_loader):
                    ...
                    img_scale = 2047.0
                    # print(visuals['SR'].shape, visuals['MS'].shape)
                    result = normlization(visuals['SR'])
                    hr = normlization(visuals['MS'])
